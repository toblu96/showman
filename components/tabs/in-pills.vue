...
<script setup>
const tabs = [
  { name: 'Devices', href: '#', count: '52', current: true },
  { name: 'Operation Center', href: '#', current: false },
  { name: 'Contract', href: '#', current: false },
  { name: 'Members', href: '#', count: '4', current: false },
  { name: 'Contacts', href: '#', count: '6', current: false }
]
</script>
